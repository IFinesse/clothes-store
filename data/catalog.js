 window.catalog = [{
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: './images/1.start/1.jeans2.png',
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: './images/1.start/1.with_patckwork.jpg',
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Green'],
    sizes: ['UK 19'],
    thumbnail: './images/1.start/1.neck_knitted.jpg',
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 17'],
    thumbnail: './images/1.start/1.only_skinny.jpg',
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: './images/1.start/1.turtle_neck.jpg',
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
